...
**TKTK: Describe the-listening-project here.**
...
```
cd the-listening-project
mkvirtualenv --no-site-packages the-listening-project
...
```
* * * * * ubuntu bash /home/ubuntu/apps/the_listening_project/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|the-listening-project|tweet|`location`||||
|the-listening-project|facebook|`location`||||
|the-listening-project|email|`location`||||
|the-listening-project|new-comment||||
|the-listening-project|open-share-discuss||||
|the-listening-project|close-share-discuss||||
|the-listening-project|summary-copied||||
|the-listening-project|featured-tweet-action|`action`||``tweet_url``|
|the-listening-project|featured-facebook-action|`action`||``post_url``|
